...
import {
  ...
  setOutput,
  setOutputAmount,
  setIndependentField as setSwapIndependentField,
  update,
      ...
      try {
        ...
        const params = {
          ...
          buyToken: output?.tokenIdOnNetwork
            ...
            : input?.symbol.toUpperCase(),
          sellAmount:
            independentField === 'INPUT' ? total.toString() : undefined,
          buyAmount:
            independentField === 'INPUT' ? undefined : total.toString(),
...
export const useSwap = () => {
  ...
  const setIndependentField = useCallback(
    (value: 'INPUT' | 'OUTPUT') => {
      dispatch(setSwapIndependentField(value));
    },
    [dispatch],
  );
  return {
